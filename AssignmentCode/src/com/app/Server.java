...
public class Server {
	...
	public Server(int port, String encryptionKey) {
		try {
			...
			// Initialize the secret key and cipher for encryption and decryption
	...
	private void initializeData() {
		...
		// Initialize data for different sets
	...
	private class ClientHandler extends Thread {
		...
		public void run() {
			try {
				// Accept and process client messages
		...
		// Methods for encrypting and decrypting messages
